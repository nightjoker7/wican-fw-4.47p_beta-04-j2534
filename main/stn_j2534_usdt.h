...
// USDT buffer sizes - sized for GM SPS/DPS programming (up to 4012 byte TransferData blocks)
#define USDT_TX_BUFFER_SIZE         4500    // Max TX message size
#define USDT_RX_BUFFER_SIZE         4500    // Max RX message size
